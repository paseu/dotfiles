...
beautiful.init("/home/paseu/.config/awesome/themes/default/theme.lua")
...
tags = {
   names  = { "main", "studio", "game", "gimp", "office" },
   layout = { layouts[9], layouts[2], layouts[11], layouts[5], layouts[6]
 }}
 for s = 1, screen.count() do
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "Return", function () awful.util.spawn("urxvtc") end),
