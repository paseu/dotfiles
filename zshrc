...
alias montemp="nvidia-smi -a|egrep -i current\ temp\|fan && sensors | egrep -i Physical\|fan1"
alias jnlcheck="journalctl -b0|grep -v -i "tor"|grep -i 'warn\|error\|fail\|critical\|fatal\|already\|??'"
